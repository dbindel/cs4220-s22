...
# ╔═╡ bf23ae4c-db54-489d-8753-93e48d0eb3ce
using LinearAlgebra

# ╔═╡ 87c32486-7495-4a97-baee-387e973089ce
using Plots

# ╔═╡ 2fd4ea16-bb9c-11ec-3790-216963be2228
md"""
# Notebook for 2020-04-18
"""

# ╔═╡ 94c29b1f-9aa7-49bd-aa87-dafbb64e77d3
md"""
...
# ╔═╡ 5a36eeb1-237a-4b38-aa4d-076c4ad8f874
md"""
...
# ╔═╡ 832c108e-6190-42b4-aba8-51b28c0bc384
md"""
...
# ╔═╡ 65f1756d-5f5e-4603-a9e2-b6c877f927f2
begin
...
# ╔═╡ 8db159e1-a2c1-4f4f-bced-82020b89da39
md"""
This is a convex function with a unique global minimum $\phi(0) = 0$. To find this minimum, we might first consider Newton’s iteration:

$$x_{k+1} = x_k - \frac{\phi'(x)}{\phi''(x)} = x_k - (1+x_k^2) \tan^{-1}(x_k).$$
"""

# ╔═╡ 7b4d9db3-e51d-46b2-aa17-9ae80afe695d
let
	x = 1.0
	xhist = [x]
	for k = 1:10
...
# ╔═╡ f19bc40e-b574-4c57-a99e-b75ffef44b8e
md"""
...
# ╔═╡ 6d47b114-fbff-4844-84a6-a5c82466d347
let
...
# ╔═╡ 83dd3a8e-1bc6-456e-bc97-8c6a99df2313
md"""
...
# ╔═╡ 0da07f00-4391-4c72-b622-e05b134aa9c9
let
	ξ = 1.391745200270735
	x = ξ-1e-3
	xhist = [x]
...
# ╔═╡ cc5ca570-5af2-4475-b58a-20541f975f51
let
	ξ = 1.391745200270735
	x = ξ+1e-3
	xhist = [x]
...
# ╔═╡ c0f96e93-59f4-4dd2-97e0-d28e3df86747
md"""
...
# ╔═╡ 1ad77100-4d5b-4606-9729-51ca51fe3edc
...
# ╔═╡ 6803939a-59e5-4720-bd49-0a4e341bddb1
let
	x0 = 10.0
...
# ╔═╡ 31479315-8ece-495c-99c3-0ccd2a711259
md"""
##### Questions

1.  Where did the equation for $\xi$ come from?
2. Write a monitor function to verify that $\alpha = 1$ in the call to backtracking Newton on this problem iff $|x| < \xi$.
"""

# ╔═╡ 03f9047c-457b-4384-8e8b-2b1d04c27864
md"""
### Obscure oscillation
...
# ╔═╡ 5b95fadf-d9ac-480d-a1d2-6141d91dccd4
begin
...
# ╔═╡ 5e962710-5bff-468e-8e43-b58a07ccdfe4
md"""
...
# ╔═╡ 030f4464-d6b8-4656-b297-84421b4b01d3
let
	x = 1.01
	xhist = [x]
	for k = 1:50
...
# ╔═╡ bb17e348-520e-4987-814c-4e2350ab1561
md"""
...
# ╔═╡ 98d01ffb-1bca-45de-b029-5156d7e2b4ed
md"""
##### Questions
...
# ╔═╡ 2c34991f-8115-4316-a39c-06ca5e6135ef
md"""
...
# ╔═╡ 283ae880-e539-4975-b900-3733f69ada84
begin
	...
	plot(plot(xx3, ϕ3.(xx3), label="phi"),
		 plot(xx3, dϕ3.(xx3), label="phi'"), layout=@layout [a; b])
end

# ╔═╡ 2f9bea7f-4120-4292-af2c-31ea88a129da
md"""
...
# ╔═╡ 94e2eeae-ba23-4434-9436-06af623ab268
md"""
##### Questions
...
# ╔═╡ e9b60db9-af3e-4fa8-8186-374c29da78a0
md"""
...
# ╔═╡ f86ad40b-0c75-4ca0-bb7e-6b197050ddd1
...
# ╔═╡ 280d41c9-4234-49c2-a230-a176090587cc
let
	x0 = 1.01
	xhist = Array{Float64,1}([])
	αhist = Array{Float64,1}([])
...
# ╔═╡ 69051900-803c-462e-95e5-f4789284500d
md"""
...
# ╔═╡ 3b4b5900-5c46-49ca-8b97-54fb4008fefa
md"""
...
# ╔═╡ b6f70365-1573-49c7-80d5-64c231f94048
md"""
## Global convergence
