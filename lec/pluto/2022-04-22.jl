...
# ╔═╡ fefcd04f-3533-4f78-8d85-382f2bb779f5
using LinearAlgebra

# ╔═╡ 5bc4cb8a-8507-48a7-b57d-096070f778e0
using Plots

# ╔═╡ 2e34204a-bba2-11ec-28ed-f7f234edabf6
md"""
# Notebook for 2022-04-22
"""

# ╔═╡ 6128bb6f-1a2d-495a-8f05-a435e6d846d5
md"""
## Pacing the Path
...
# ╔═╡ db9e3c74-eb3c-4198-8eee-51b1cc8d7bf6
md"""
## Tough to Trace
...
# ╔═╡ 179ff34f-a2de-424c-b87b-c76b79b1edc4
...
# ╔═╡ d7d61a11-3edb-405a-b050-3c82e1511e8c
function Jautocatalytic(v, γ)
    N = length(v)
    SymTridiagonal(γ*exp.(γ*v) .- 2*(N+1)^2, (N+1)^2 * ones(N-1))
end

# ╔═╡ d9d6dafb-1ef6-48da-ba44-c2ab9e17f868
function dγ_autocatalytic(v, γ)
    v .* exp.(γ*v)
end

# ╔═╡ 830bd6e5-ff2f-4103-83bb-6c6c912eb23e
md"""
...
# ╔═╡ 8a11fe75-b4ba-462b-9e87-b3456cff140d
let
...
md"""
##### Center temperature vs gamma

Last converged point at γ = $(γs[end]))

$(plot(γs, vcenter, xlabel="gamma", ylabel="vcenter", legend=false))

##### Largest eigenvalue of Jacobian vs gamma

$(plot(γs, λs, legend=false))
"""
end

# ╔═╡ dcc9a627-314c-4063-94dc-1af183c60c40
md"""
## Picking parameters
...
# ╔═╡ d2743393-8de0-4aeb-9834-5bda19c31e87
let
	xall = range(0.0, 1.0, length=200)
	xint = xall[2:199]
...
# ╔═╡ d51580cf-8633-4d64-b95c-42a9c2cc046f
md"""
...
# ╔═╡ 8b676083-be86-4fe1-a26c-f131793df8c9
md"""
...
# ╔═╡ 59135dff-8d83-4496-82cd-90b3c145127d
let
	xall = range(0.0, 1.0, length=200)
	xint = xall[2:199]
...
# ╔═╡ 06c41d17-71e9-4b40-91d0-31e79d3b2b4c
md"""
## And Points Beyond
