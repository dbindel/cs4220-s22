...
# ╔═╡ 89798d42-c520-4e4d-b3d8-9d20b6b8fdcd
using Plots

# ╔═╡ 130a35dc-a7b8-11ec-24e1-391a8990c0dd
md"""
# Notebook for 2022-03-21
...
# ╔═╡ a81501dc-690e-4d8e-9896-37a6d73e096f
md"""
## Long division
...
# ╔═╡ e6684b7e-feb9-47ec-8e61-305f4782956f
...
# ╔═╡ 46c9bbdf-b775-423e-8374-8b0967f00b91
begin
	rd_errs = []
...
# ╔═╡ 7d46322e-e608-4e7d-9d49-20e085ee3ca1
md"""
## Bisection
...
# ╔═╡ 9f49f403-08a8-456a-a257-69ff847a62b1
...
# ╔═╡ 36b695be-da80-4006-aaf4-280107d85533
begin
	rb_errs = []
...
# ╔═╡ 6a42e5b4-012f-4227-95f3-1f738531ecee
md"""
...
# ╔═╡ cff8474e-f5b0-4faa-89e8-08a45b1402e8
function reciprocal_newtonish(d, d̂, n; monitor=(x)->nothing)
	x = 1/d̂
	for k = 1:n
		monitor(x)
		fx = d*x-1
...
# ╔═╡ 667272fa-f9c4-4031-8325-c9f3d2977789
begin
	rn1_errs = []
...
# ╔═╡ 92fb93aa-3371-4894-979d-6651bb7b1806
md"""
## Newton iteration
...
# ╔═╡ a6c192d8-430d-4d92-9f47-f138a1c1292c
...
# ╔═╡ 101542ec-f410-46d0-bcd1-28878de95553
begin
	rn2_errs = []
...
# ╔═╡ e09ede68-18e2-42b9-8522-943e791ecdf7
md"""
## Comparing methods
...
# ╔═╡ ffdcfc7d-2d77-4599-92cf-beb9208d070b
begin
