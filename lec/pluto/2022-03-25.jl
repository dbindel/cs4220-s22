...
# ╔═╡ aede13e1-5835-4d75-9347-78a71e82951f
using Plots

# ╔═╡ 0b29f2cb-dd46-4d92-9f64-a5e9abb90212
using LinearAlgebra

# ╔═╡ 83848410-a8a9-11ec-1792-2ba4060e72e9
md"""
# Notebook for 2022-03-25
...
# ╔═╡ b330036e-ffb9-4af1-b6e6-44bdd516365d
begin
...
# ╔═╡ e69da011-65b6-4513-97b0-1bf446ae3987
md"""
## Newton's iteration
...
# ╔═╡ 75542057-af72-494c-a707-0ae6ab453536
...
# ╔═╡ 5fdcec7b-aaa9-427a-acef-94f760915dd2
newton_opt1d(g, dg, 1.0)

# ╔═╡ 55665841-a248-496f-898b-6e3264da21dd
newton_opt1d(g, dg, -1.0)

# ╔═╡ 8c41323b-f2ba-4c7f-bd54-c285dd653b80
md"""
## Golden section
...
# ╔═╡ 879f7b93-f168-4fe7-b6e6-24fcedd213f5
function golden_section(ϕ, a, b; xtol=1e-6, maxiter=100, monitor=(a,b)->nothing)
	...
	for k = 1:maxiter
		...
		if ϕ1 < ϕ2  # Minimum is in [a,x2], shrink interval
			...
			ϕa, ϕ1, ϕ2, ϕb = ϕa, ϕ(x1), ϕ1, ϕ2
			
		else        # Minimum is in [x1,b], shrink interval

			# Note: x2 = get_x1(x1, b)
			a, x1, x2, b = x1, x2, get_x2(x1,b), b
			ϕa, ϕ1, ϕ2, ϕb = ϕ1, ϕ2, ϕ(x2), ϕb
...
# ╔═╡ baa82cd9-6173-401a-8340-c3a2345dc7b2
begin
	errs = []
	lost_bracket = false
	function gsmon(a,b)
...
# ╔═╡ d69f8622-898a-45e2-bc27-c1dc4fbe6fac
