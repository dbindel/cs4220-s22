...
# ╔═╡ c278bba3-ef3c-4039-8b57-d78ddc106a01
using LinearAlgebra

# ╔═╡ b5d0f268-a7b5-422d-912a-62ed4b185d74
using Plots

# ╔═╡ 9a1606f2-a22a-11ec-0043-81bb4f14eeb7
md"""
# Notebook for 2022-03-14
...
# ╔═╡ 81665904-1d4e-4c01-b4e8-f1594fd730fe
md"""
...
# ╔═╡ 9e8223bd-4c47-4636-8d71-06afe30e9f02
spectral_radius(R) = maximum(abs.(eigvals(R)))

# ╔═╡ 20950992-89d4-4cec-a4d0-29cf1ce78779
Arand = rand(10,10)

# ╔═╡ 901ad8c7-387f-4dd2-97ce-57f79d239c7d
spectral_radius(Arand)

# ╔═╡ 5771d78d-1929-47e4-9030-6f11ea820dd3
opnorm(Arand)  # Operator 2-norm

# ╔═╡ fa0c01e7-8352-4ac5-9843-3e8a492b2486
opnorm(Arand,1)  # Operator 1-norm

# ╔═╡ 51dd2469-0b37-46e9-847b-46e33df0ba8b
opnorm(Arand,Inf)  # Operator ∞-norm

# ╔═╡ 47c1e46d-c74e-4a72-b0de-b6f9205efe91
md"""
...
# ╔═╡ 160d7c43-3a4f-41b1-8be1-ead88816e3f5
norm(Arand)

# ╔═╡ 984d55fa-fd90-4d2a-90d9-56daf33499d7
sqrt(sum(Arand.^2))

# ╔═╡ 5418dfa5-7721-4a47-8431-b9f16e8b82dc
md"""
...
# ╔═╡ 63086184-f124-4151-b742-503f3bb8ddc9
...
# ╔═╡ 34b07499-278e-457f-b838-2626ee42ff8d
...
# ╔═╡ c7099e2b-f2e5-4a4a-b947-4e0cfee72964
test_richardson()

# ╔═╡ 005efec9-4960-4b82-b008-42344da7441b
md"""
## PageRank
...
# ╔═╡ f7ceead3-7f51-49ff-aa85-818d0700b5c3
...
# ╔═╡ 8190597c-ade2-4d6f-801e-eaf1625ac3a7
...
# ╔═╡ 28c995b2-343c-40a0-94bc-286828036dad
test_pagerank()

# ╔═╡ 46dce59a-c078-43a4-81d3-018a3260daf1
md"""
## Jacobi iteration
...
# ╔═╡ b8bf34f9-53bf-4157-8efe-8e266b736823
...
# ╔═╡ 5b31c531-3d74-40ed-8a3e-4a0d9e2f39ff
...
# ╔═╡ 6c19106a-d5b3-47fd-bed4-09209759d291
test_jacobi()

# ╔═╡ 99c3782f-c23f-4007-932a-9aa4eb078f62
md"""
## Gauss-Seidel
...
# ╔═╡ ba67e8e3-cbe4-405a-ad9e-52fa603a576e
...
# ╔═╡ af516e8d-42b7-487a-8921-a39fb827a239
function test_gs()
	Z = rand(15,10)
	A = Z'*Z
	b = rand(10)
...
# ╔═╡ 666d1465-ca2b-4cd7-84f5-6786fb324670
test_gs()

# ╔═╡ 67aecaa6-d787-4b30-b6d4-433c29c88e91
md"""
...
# ╔═╡ d75f9088-1d28-4329-84fd-dc9ae0e08426
Tpoisson(N) = SymTridiagonal(2.0*ones(N), -1.0*ones(N-1))

# ╔═╡ f2bfe56b-8ad2-492b-87ed-40375fb8d90c
Tpoisson(10)

# ╔═╡ b497625d-e45d-486a-bd94-257dea38b3c8
md"""
...
# ╔═╡ d67b31d4-328b-45af-b2d2-4a7bc525c1b7
...
# ╔═╡ ecde64bd-fd60-44c8-8753-5a2e5e0a5069
test_poisson_solve1(10)

# ╔═╡ 295dd1f4-e139-466f-8d8d-e0063ee7a40a
md"""
...
# ╔═╡ 222e80d6-36f0-4eb4-8032-5aaa40dbd7a3
...
# ╔═╡ 06a13af5-352d-4939-9af4-0e6e85ca70e3
...
# ╔═╡ 273af483-a1bd-4836-a3c9-1675fed0f32e
...
# ╔═╡ dc013fb6-6073-455b-a491-bf8dbbfa147c
md"""
...
# ╔═╡ aeae6b1c-52b5-4b47-ac28-45def6dc6f59
test_poisson_solve2(10)

# ╔═╡ ef6633a7-b052-41b6-ba4d-b9382ce356d3
test_poisson_solve2(100)
