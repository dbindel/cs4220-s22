...
# ╔═╡ 8d3d9407-936e-403a-939f-0f542bc2e222
using LinearAlgebra

# ╔═╡ cff2ab37-5a79-4da7-b0d5-2bf117a564d8
using Plots

# ╔═╡ 342bf422-ae10-11ec-0cc8-9787e9dbfe25
md"""
# Notebook for 2022-03-28
...
# ╔═╡ 3386ef4e-65c6-45a9-b88b-6ab5d37bf080
md"""
...
# ╔═╡ 0f3b7181-a982-4d8f-912d-4ece63bb418e
ftest(x) = [x[1] + 2*x[2] - 2; x[1]^2 + 4*x[2]^2 - 4]

# ╔═╡ a9e9b213-895e-4d6b-a869-1e3863d219a2
md"""
Now define $g(s) = f(x_0+su)$ for some randomly chosen $x_0$ and direction $u$
"""

# ╔═╡ 8a3f9089-6e8c-41a8-b29f-815bfb732f16
begin
	x0 = randn(2)
	u = randn(2)
...
# ╔═╡ d8b6f00f-a2ad-4c5a-8688-3e8cfbb6952c
begin
...
# ╔═╡ edbb419b-2a27-4433-b1e0-bdb3c2cd78cd
md"""
...
# ╔═╡ 039065e6-7a7b-4e09-8b55-b536bc961a3a
begin
...
# ╔═╡ 2454a0c5-4549-422b-9ed6-521fad693d1a
md"""
...
# ╔═╡ ee3880fe-3587-4a7a-b93b-011702ac98ac
begin
...
# ╔═╡ b0413cbd-de42-416c-859d-fdd1a2b6264d
md"""
...
# ╔═╡ c2262fb3-9caa-4a60-9051-11fae05b1096
begin
...
# ╔═╡ 5e9d439b-1bbf-4e59-95dc-844cb26645b7
md"""
...
# ╔═╡ 3cc2d7f6-dd2a-4d6a-a4cc-14f89a3ea484
begin
...
# ╔═╡ 27504b98-5bed-4a34-9155-5a35ac141c84
md"""
...
# ╔═╡ 7dbb1354-3174-4201-940e-1f97833234c1
begin
