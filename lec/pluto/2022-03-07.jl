...
# ╔═╡ 2845a66c-f26e-4fa8-b5e3-2bb6da162a3d
using LinearAlgebra

# ╔═╡ e42025b3-cbc0-4c2e-b205-23649d520ca8
using Plots

# ╔═╡ 701f71ca-9da3-11ec-0fdc-75ba7de671c0
md"""
# Notebook for 2022-03-07
...
# ╔═╡ 257e5ac1-b35a-46e1-8edd-669a793a52ca
A = rand(10,10)

# ╔═╡ 5684c3d3-c0c6-48db-9a70-84c0987e47c2
md"""
...
# ╔═╡ c31eeec6-320d-45bd-a835-23bae3f3c07e
...
# ╔═╡ 139f0590-b1d0-4fca-862b-3c6720728b7a
md"""
...
# ╔═╡ 2783596e-6c5a-4d65-a836-2c035e7a9fa8
...
# ╔═╡ 92556596-ccbb-4bec-9a66-f19144e5d4e1
...
# ╔═╡ 9cc8b51a-c024-4ec7-aeb2-f57b711036d3
md"""
...
# ╔═╡ bc1289eb-8581-4c0c-a969-388fec0931f7
begin
	λs = eigvals(A)
...
# ╔═╡ a41bb243-a93e-499e-b4a6-72b906392603
md"""
## Shift-invert
...
# ╔═╡ 8650a77a-a2d7-47e4-8bab-d10f6071a298
...
# ╔═╡ 507681cb-5e3c-4c97-bf6d-86b572a49d7e
...
# ╔═╡ c34e1910-ecbd-4db3-aa63-3c7d3f2934a4
md"""
...
# ╔═╡ 4ccef2f9-4ac3-49d8-9394-7829205c3e0f
begin
...
# ╔═╡ 45ef4100-d26e-4f8d-a1fd-cc41820bde55
md"""
...
# ╔═╡ 68f97b53-8d6e-4113-85c6-930d8f3d8887
...
# ╔═╡ 7cec40dd-5437-4baa-9e8a-be21704561a3
...
# ╔═╡ 889b9b00-4862-4579-9306-6adecb33a9bf
md"""
...
# ╔═╡ c1d8dd47-078c-46df-8894-0161afd34876
plot(test_rq_method(A, 20, 5.0), yscale=:log10, label="Residual")

# ╔═╡ efadc296-cf0b-40c3-a2f2-82f205075098
md"""
## Subspace iteration
...
# ╔═╡ fc1dbb12-b5fe-409a-9efd-4f21ee01fef3
sympart(A) = (A+A')/2

# ╔═╡ 0f472787-fa3d-4f4b-bcd3-3d504a22e8d8
AA = sympart(rand(10,10))

# ╔═╡ 3b2b7954-66fb-4799-a0a2-cf2472cbac0e
...
# ╔═╡ 724eba27-8161-4524-afe0-b4979bfb8bba
md"""
...
# ╔═╡ bc437e33-36a8-48c9-83d6-ff5978987408
function subspace_resid(A, Q)
	Y = A*Q
	norm(Y-Q*(Q'*Y))/norm(Y)
end

# ╔═╡ a819e65d-2f8d-437b-832b-e00ea8cada3a
