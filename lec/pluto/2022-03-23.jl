...
# ╔═╡ 01f272a1-f7d9-4c03-917f-30a288d21dfe
using Plots

# ╔═╡ 4729c6c1-4aee-4c09-ad2e-343697d06755
using Roots

# ╔═╡ 847ce716-a7c0-11ec-33a5-cd88827a276a
md"""
# Notebook for 2022-03-23
"""

# ╔═╡ bdd593f1-c53b-4b80-84d3-53a4cf069ed9
md"""
## A test problem
"""

# ╔═╡ e3c1a49e-1c28-49cf-827b-5474a5459d29
begin
	testf(x) = x^3-2*x+1
	dtestf(x) = 3*x^2-2
...
# ╔═╡ b5f6fdf1-9c33-4c02-8394-31f003db0ce9
md"""
## A bisection routine
...
# ╔═╡ d5219812-c449-4ed7-8fff-c734cf966892
...
# ╔═╡ e1284d3d-5f3d-4c99-babe-77a991f8152f
begin
	resids_b = []
...
# ╔═╡ 607c9a56-4020-41ad-9f29-6e4288d22316
md"""
## Unguarded Newton
...
# ╔═╡ 66350359-e222-4168-88a1-014d9acf1260
...
# ╔═╡ fba6100d-d9e2-427f-b422-84678411c2af
begin
	resids_n = []
...
# ╔═╡ aafa78fc-6c72-4a17-99c9-e59a7ce62cfb
md"""
...
# ╔═╡ 5b48b0a4-ad3c-4557-84b0-841299811c91
begin
	resids_n2 = []
...
# ╔═╡ e8ad1f9d-8580-4ef3-895c-b4113d164aef
md"""
## Guarding Newton
...
# ╔═╡ abb94651-dde9-4d07-8cd2-f94577b292d1
...
# ╔═╡ 21789cdd-534f-4f9e-aa1d-2a63df085b28
begin
	resids_n3 = []
...
# ╔═╡ 9b06b6b1-8fe3-4ef4-a131-ec2c6e837746
md"""
## Secant iteration
...
# ╔═╡ 8f1f4eb9-6bb4-478a-afb4-5f28f52b940c
...
# ╔═╡ b65bf225-95f6-4d50-ad8b-ad7adc6dd62e
begin
	resids_s = []
...
# ╔═╡ de479f8e-54c0-42a0-af24-e1b709693280
md"""
## Using `fzero`
...
# ╔═╡ 50d99080-ef32-4da3-84da-01b18c76b9d4
find_zero(testf, (0.5, 0.8), Roots.A42())

# ╔═╡ 8ea91284-5597-4252-ae35-19d2e59e716b
md"""
...
# ╔═╡ d780bfcc-37a3-4ece-9688-d8b4841e2046
begin
