...
# ╔═╡ 445fc6f2-7d37-11ec-1e73-577925e4c35f
using Plots

# ╔═╡ b52ec316-ff78-4c2d-94bf-ca2303346a55
md"""
...
# ╔═╡ 54794042-35bc-4127-9d6b-4646e25004c3
md"""
...
# ╔═╡ c47d3e23-21f4-43fb-a75a-fc5e988092c3
A = [1.0 2.0; 3.0 4.0]

# ╔═╡ dd335540-485d-4350-9f2c-92ee37163444
x = [5.0; 6.0]

# ╔═╡ 12a9771c-8fde-40b9-bb99-86211765ee57
A*x

# ╔═╡ b36f8429-a2f5-44c5-85b5-d88e38dfb67b
md"""
...
# ╔═╡ 81e8e7a8-10e5-4518-a97f-577fae551cc8
...
# ╔═╡ aa53bdff-3a3c-4baf-9f57-ff23211885e3
matvec_row(A, x)

# ╔═╡ 20ef0955-f8d1-449d-a61c-d365ff83afc7
...
# ╔═╡ 93c7ceda-89ef-42e6-9a4e-046799543d18
matvec_col(A, x)

# ╔═╡ dbf85b82-e5f5-4f73-8b29-8b3c28ed0252
md"""
...
# ╔═╡ 0bef1c62-e59e-4180-8175-54e1115bf4fc
test_sizes = []

# ╔═╡ 2b7947c4-4876-4bc6-9871-a7a5c0ceea89
for n = 128:128:1024
	push!(test_sizes, n-1)
	push!(test_sizes, n)
	push!(test_sizes, n+1)
...
# ╔═╡ df59281d-7b67-4158-97c4-c7d412ff3cc8
test_sizes

# ╔═╡ 804c681f-32d4-4267-973a-9abc0f13f0dc
md"""
...
# ╔═╡ 00457bfb-ccb0-4f91-9f11-f854b60086dd
...
# ╔═╡ 323a92ff-5c1d-4250-88f9-b3dda38c0fc3
md"""
...
# ╔═╡ 54bb8593-b48a-4778-a7db-313b80272ae6
begin
...
# ╔═╡ 07bcea71-a747-40cf-b91f-c560875bbda2
md"""
...
# ╔═╡ 259726fd-c876-40a5-a464-575756249095
...
# ╔═╡ c4bcb3d5-6267-4d58-9d9b-22a19bc22684
...
# ╔═╡ 9cc03b3c-0c01-4008-acbd-a87b36d3381b
md"""
We again write a uniform timing harness for the three codes.
"""

# ╔═╡ 4b309aa0-eea8-4570-9998-93dcd8b2db63
...
# ╔═╡ 92793b45-2596-4571-ae1d-f420e2296f08
md"""
