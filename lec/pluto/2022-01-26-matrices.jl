...
# ╔═╡ 059f4fdc-7d91-11ec-1c36-e145fe75249a
using Plots

# ╔═╡ 5e347319-177e-4fb2-8c85-3f18b8d81f92
using LinearAlgebra

# ╔═╡ 9d7a4671-eab4-4954-9780-3c477c703541
md"""
...
# ╔═╡ 6296392c-3e07-48ee-8324-8d92f2cff74b
md"""
## Twelve commandments
...
# ╔═╡ 683f62f7-5886-4675-bc13-d0d02ada59d9
A = [1.0 2.0; 3.0 5.0]

# ╔═╡ fca4cdf5-a1a2-4a82-b27d-8e02c83ff342
B = [7.0 8.0; 9.0 12.0]

# ╔═╡ 4f31072b-a443-43be-b8fb-d169cd4c7e36
x = [1.0; 2.0]

# ╔═╡ e8dac7cd-3a65-4e8c-9a46-5338ef620d21
md"""
...
# ╔═╡ 3cd764d9-0c0b-4c45-83f1-6dbe02bcb997
...
# ╔═╡ ee3fd01a-9de6-41c2-b0de-bf5c1c31451f
matvec_col(A, x)

# ╔═╡ 32c3e444-b98a-4996-b550-95e00806ff1e
A*x

# ╔═╡ 2b820a13-a093-479e-b7d7-3d13e069d8ee
md"""
...
# ╔═╡ 0cd94e85-2aa4-4a43-9dae-a2dd3605d2da
function my_dot(x, y)
	result = 0.0
	for j = 1:length(x)
		result += x[j]*y[j]
...
# ╔═╡ b5e211e9-cfaa-4b3e-b940-eb85354f72e8
my_dot(x, x)

# ╔═╡ 41ad43eb-debe-48e7-926c-04e4080824da
x'*x

# ╔═╡ 68a66bad-1249-4e74-b6dc-dc0e0ef41976
md"""
...
# ╔═╡ a2b48564-8763-4ed6-9232-4bd27c293545
ubig = rand(5000)

# ╔═╡ 04a2cd88-960e-40ef-a437-582cfc07078d
vbig = rand(5000)

# ╔═╡ ee82d157-fbf3-490c-be70-7f94f78a2370
wbig = rand(5000)

# ╔═╡ d13d3535-c75f-4ad3-9d16-68c3a64a86b6
@elapsed ubig*vbig'*wbig

# ╔═╡ 9265774c-0607-4434-9f82-510079a8c92e
@elapsed ubig*(vbig'*wbig)

# ╔═╡ 41a2e5c2-bbcf-4a2b-ab8a-81a46e4177d4
md"""
...
# ╔═╡ c18d81f7-51b5-403d-a435-1fab67262c32
diagm(x)

# ╔═╡ 772c8483-0d62-4d52-a16b-e1f7289d76c4
Diagonal(x)

# ╔═╡ 9a9e1d43-6249-48a5-b000-80b8ef726aa7
md"""
...
# ╔═╡ 81afcea9-c4d2-4b59-924a-3481f838bf35
A .* x   # Computes row scalings via Julia broadcast ops (could also do x .* A)

# ╔═╡ 7045bc3e-fac9-4944-83fa-c269096a61af
x .* A   # I said we could do x .* A -- may as well show it's true!

# ╔═╡ fda232e0-9bbd-46f4-8b9c-7a83eabff13a
Diagonal(x) * A

# ╔═╡ bf780eb5-d8e7-475e-ba26-42ed73ca7b35
md"""
...
# ╔═╡ 322d03e6-14cc-4547-b648-35d70cbd31a4
md"""
...
# ╔═╡ ab3efc3b-8b79-493a-85b1-56b32e99abdd
md"""
...
# ╔═╡ d4a15b9c-dece-4dcc-b893-688e7c275102
...
# ╔═╡ b8180f72-b5f3-43f4-bc23-a7c866285720
A*B

# ╔═╡ 9bb1949a-53e8-41a7-b1db-9fd9cf2dbcf5
matmul_col(A, B)

# ╔═╡ 4323e696-3a80-4c7f-95b7-ffcf40b359a6
md"""
...
# ╔═╡ ce196da0-befa-4a8c-8f08-c3648419b330
...
# ╔═╡ fa15948d-df89-400b-9be7-c0bdd4d32e66
matmul_dots(A, B)

# ╔═╡ a9558cbe-3d32-47dd-ba6d-b3ab19cd1ff5
md"""
...
# ╔═╡ 53662b99-4d75-4efa-b68d-3e536f9fac2d
...
# ╔═╡ 4cfecbdc-a405-4cc8-8460-be13e553a058
matmul_outer(A, B)

# ╔═╡ dd02844a-2c5b-4f35-bb82-d49608808a1d
md"""
#### $AB$ involves linear combinations of rows from $B$
"""

# ╔═╡ d342fed6-5dbc-4b4d-bc43-4a4a91e52e87
...
# ╔═╡ 807113e9-54c8-4a03-930b-08f2756f7503
matmul_rows(A, B)

# ╔═╡ be70c732-6495-4942-97ac-10392c21c72e
md"""
...
# ╔═╡ e7636867-d55c-4cc5-986d-44ef1d9cead1
md"""
## Block matrices
...
# ╔═╡ 299b49dc-9e43-4827-9705-00359d155c77
b = [7; 11]

# ╔═╡ 33f531f0-5f94-4563-bf8e-4cfefa956ef3
c = [13; 14]

# ╔═╡ 812ac278-7f0e-443d-aaa4-30fc6147a631
d = 42

# ╔═╡ 8f71fc62-3ae9-4922-a4d6-b4dfc11043fe
M = [A b; c' d]

# ╔═╡ d5f98f3a-f7c2-44a1-8005-f206ac19ebb6
md"""
...
# ╔═╡ aa1509aa-d371-49ff-b978-6a82526c543c
z = rand(3)

# ╔═╡ b52bbbe1-d003-4646-9a52-186e65c38471
M*z

# ╔═╡ 39d9030c-55bb-4c53-9e69-7f3158fa7e50
[A; c']*z[1:2] + [b; d]*z[3]

# ╔═╡ b2e5dedc-a244-48ee-9710-f1a1a2077dfa
md"""
Alternately, we can write a matrix-vector product in terms of rows.
"""

# ╔═╡ 383830c7-0c8b-4976-8803-fbb77f12580f
[ [A b]*z ; [c' d]*z ]

# ╔═╡ d1176eb1-a6bb-4abe-b758-fa0f8f3a279c
md"""
...
# ╔═╡ 5ebfd1a9-aa1d-4fa2-8003-806036ebe0bc
M2 = [Diagonal(x) b; c' d]

# ╔═╡ 3550772e-8c5f-4bb7-a593-d7df28498558
md"""
...
# ╔═╡ f4405a38-be4a-4ed8-afd0-7570bbfd5ae0
Arand = rand(5,5)

# ╔═╡ 958db068-8b38-4eac-9e71-e87ccd4c95bb
triu(Arand)

# ╔═╡ 5f7175f0-d007-4698-a733-73652eea7385
tril(Arand)

# ╔═╡ fbece44d-9b47-436a-a76d-4a89e385d893
md"""
...
# ╔═╡ d696215f-c3f0-435b-959e-4ed2fccbd842
UpperTriangular(Arand)

# ╔═╡ b42035b9-0ddd-404b-a5d2-58bf97eaa0d8
LowerTriangular(Arand)

# ╔═╡ 88a2369a-51c5-4b6b-9a6d-0186927ceb7f
md"""
...
# ╔═╡ fdcd5c43-cae0-45db-aeff-824076919733
spy(triu(rand(100,100)))

# ╔═╡ 3edc6ed1-3c53-42c0-bbaa-6706149797a6
md"""
...
# ╔═╡ f84aafd7-d445-4a26-915d-cc7cef1159d6
triu(Arand,-1)

# ╔═╡ 862ac974-6dc0-40aa-b143-14163bd764b7
tril(Arand, 1)

# ╔═╡ 7fe8c1d6-45a8-4f6f-ba1e-c80a2832394e
md"""
