...
# ╔═╡ 2d20d6d5-8627-421b-943f-beeaf41bcc58
using LinearAlgebra

# ╔═╡ 4a80a34f-a475-4af9-8e1b-e94bad852dd5
using Plots

# ╔═╡ d2d2d3d0-3636-47a0-a45f-c3918bd383bd
md"""
# Notes for 2022-02-21

This Julia notebook corresponds to the lecture for 2022-02-21 introducing least squares computations.
"""

# ╔═╡ d93bfab0-85e5-4e1a-b7f1-062d29d9f78f
md"""
## Crickets data
...
# ╔═╡ 8ad33474-92b9-11ec-324b-09504c6d0dce
begin
...
# ╔═╡ fe957985-8f09-4289-be20-f8ad3c0d759c
md"""
...
# ╔═╡ 415bb4c5-b2ee-48c4-a7ff-cf17ffde2e98
begin
...
# ╔═╡ a46e10d3-7701-4979-ba0d-c38f7b743df7
md"""
...
# ╔═╡ 5c5c663b-8835-4595-9d86-4a4d8c77c614
(Acrickets'*Acrickets)\(Acrickets'*temperatures)

# ╔═╡ 120b57f4-71c9-4fc4-90a4-d4480f6f25c3
md"""
...
# ╔═╡ adb17c0d-9bc2-4ed9-b6b7-b53a6ae27a51
FC = cholesky(Acrickets'*Acrickets)

# ╔═╡ 75a08c13-16f7-446f-8788-2249a48c088d
md"""
...
# ╔═╡ 60b40ef8-fdbb-48c5-83b5-e902a8667c99
FC\(Acrickets'*temperatures)

# ╔═╡ e1dcdb0a-e260-4e60-af3c-d9c3b6476336
md"""
...
# ╔═╡ 584e4058-f5ca-460e-97a4-fdb31fb71132
FC.U\(FC.U'\(Acrickets'*temperatures))

# ╔═╡ 005cb416-2b20-478c-95b4-95e0341e28ea
md"""
...
# ╔═╡ d8540a0f-ebfb-463e-b313-9723a4d3e7a7
FQR = qr(Acrickets)

# ╔═╡ f2d0e72a-d58b-461d-9dc4-6fd3633316c8
md"""
As before, we can use backslash with the factorization object to solve the system all in one go.
"""

# ╔═╡ a1271cfe-8cea-4926-9d29-dcc0b08fa204
FQR\temperatures

# ╔═╡ ff9f7a95-8209-4457-9a23-339ec7003c7b
md"""
Or we can write (in economy QR lingo) that $A = QR$ means $c = R^{-1} Q^T b$.
"""

# ╔═╡ 4e6eaac2-2431-4cc2-933b-8e03da0bc078
FQR.R\((FQR.Q'*temperatures)[1:2])

# ╔═╡ 28e1337a-3d62-4ad6-b3cd-a7d70c40bdc2
md"""
...
# ╔═╡ 749bbe37-5266-42c5-9067-87f786f9f070
FSVD = svd(Acrickets)

# ╔═╡ a039ca14-ae4c-490e-b5a9-324faa170c20
md"""
As before, we can just use backslash to solve the least squares problem directly via the factorization.
"""

# ╔═╡ a0ae3953-798a-4abb-918d-c08bbbd5bcdd
FSVD\temperatures

# ╔═╡ 96dad952-e203-47e1-822e-20f9d5d1341d
md"""
...
# ╔═╡ faac0baa-4770-4372-a9e0-2ed0900b5fb9
FSVD.Vt'*( (FSVD.U'*temperatures) ./ FSVD.S )

# ╔═╡ 0fc30c20-dd47-4b12-8c08-13cd5c9b61c6
md"""
